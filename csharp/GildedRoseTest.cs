...
namespace csharp
{
    ...
    public class GildedRoseTest
    {
        ...
        public void QualityDegradesTwiceAsFast()
        {
            ...
            GildedRose app = new GildedRose(Items);
            app.UpdateQuality();
            if (Items[0].Name != "Aged Brie" && Items[0].Name != "Backstage passes to a TAFKAL80ETC concert" && Items[0].SellIn <0)
        ...
        public void ConcertQualityBehaviour()
        {
            ...
            if (Items[0].Name == "Backstage passes to a TAFKAL80ETC concert" && Items[0].SellIn <= 5 && Items[0].SellIn >= 1)
                Assert.AreEqual(Items[1].Quality, 13);
            if (Items[0].Name == "Backstage passes to a TAFKAL80ETC concert" && Items[0].SellIn <= 0)
        ...
        public void ConjuredBehaviour()
        {
            IList<Item> Items = new List<Item>
            {
                new Item() {Name = "Conjured", SellIn = 8, Quality = 10},
                new Item() {Name = "Backstage passes to a TAFKAL80ETC concert", SellIn = 3, Quality = 10},
            };
